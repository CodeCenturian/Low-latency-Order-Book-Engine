...
{
    std::cout << "\n  💰 TRADE #" << t.trade_id
              << "  price=" << std::fixed << std::setprecision(2) << to_price(t.price)
              << "  qty=" << t.quantity
...
{
    std::cout << "══════════════════════════════════\n";
    std::cout << "  LOBE – Limit Order Book Engine  \n";
    std::cout << "══════════════════════════════════\n";
    print_help();
